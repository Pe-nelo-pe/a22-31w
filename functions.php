...
function prefix_nav_description( $item_output, $item) {
    if ( !empty( $item->description ) ) {
        ...
        '<hr><span class="menu-item-description">' . $item->description . '</span><div class="menu__item__icone"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve">
